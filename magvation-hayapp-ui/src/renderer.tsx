...
const MainRendererBootstrap: React.FC = () => {
    ...
    return (
        <App
            initialNavPath={{ path: "setup" }}
            // launchState={{
            //     circulatorId: "XN2WMW4DTSDU3A37BHJVC",
            //     circulatorPassword: "Maverick123!",
            //     scrubId: "XN2WMW4DNQJPQ7VBWOWQ4",
            //     scrubPassword: "Bulldog456!",
            //     surgeonId: "1a54f7a4-0aa6-4c97-848c-f5ed4715de62",
            //     path: "cirSetupScreen",
            // }}
        />
    );
...
if (mainDiv) {
    createRoot(mainDiv).render(<MainRendererBootstrap />);
}
