...
class BaseProtocol(object, metaclass=ProtocolMeta):
    ...
    def open(cls, adapter):
        ...
        e.g.
        @classmethod
        def open(cls, adapter, ip, port=16180):
    ...
    def get_discovery(self):
        ...
        return {'TEMPLATE': 'Protocol',
                ...
                'CHILDREN': [x.get_discovery() for x in self.items if hasattr(x, 'is_child') and not x.is_child()]}
...
class WaitHandler(object):
    ...
    @run_in_broker
    def addCallback(self, fn, _async=True):
        """
