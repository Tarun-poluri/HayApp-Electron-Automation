...
GET_COMMAND_OUTPUT_PARAM_FORMAT = 1014
...
DISCOVERY_MESSAGES = [GET_ITEM_NAME, GET_ITEM_TYPE, GET_COMMAND_IDS, GET_PROPERTY_IDS, GET_COMMAND_NAME,
                      ...
                      GET_COMMAND_OUTPUT_PARAM_FORMAT, GET_PROPERTY_NAME, GET_PROPERTY_TYPE,
                      GET_SUBSYSTEMS, RESET_ITEM, GET_PROPERTY_DESC]
