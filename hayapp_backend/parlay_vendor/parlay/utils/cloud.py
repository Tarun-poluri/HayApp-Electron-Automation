...
class Datapoint(dict):
    ...
    def __init__(self, data, channel, time=None, session=None, latitude=None, longitude=None, encoding=Encoding.NULL):
...
class DatapointManager(object):
    ...
    def _set_persistance(self, obj):
        """
        Set the persistance object as a dict
        :return:
        """
...
if __name__ == "__main__":
    ...
    #DatapointManager.REST_POST_URL = "http://localhost:8000/datapoint/api/v1/datapoint-create"
    manager = DatapointManager('cd202f26-57cb-11e8-89a6-022a8fd8b278',  "persist",
                               private_key_file="/tmp/test_parlay_device",
                               private_key_passphrase='PASSWORD',
                               auto_sync_every=None)
    point = Datapoint("31337", "test.python", session="1234", latitude=1, longitude=1, encoding="JSON")
